        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="active"><a href="<?php echo base_url();?>index.php/lieu/afficher">Lieux</a></li>
...
<?php
    ...
    foreach($lieu as $lie){
        ...
        if (!isset($traite[$lie["lie_id"]])){
            $id_lie=$lie["lie_id"];
            echo "<tr>";
            echo "<td>";echo $lie["lie_libelle"];echo "</td>";
            echo "<td>";echo $lie["lie_descriptif"];echo "</td>";
            echo "<td>";
